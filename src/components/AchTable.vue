...
<template>
  <div class="container text-center fst-italic mb-2">
    Click “Add claim” to add your own claim in addition to those found automatically. Double-click a claim to edit it. Select evidence in other webpages and drag onto this panel to add. Click on a piece of dragged-and-dropped evidence to view the source.
  </div>
